[functionless](../README.md) / [Exports](../modules.md) / DoStmt

# Class: DoStmt

## Hierarchy

- [`BaseStmt`](BaseStmt.md)<``"DoStmt"``\>
...
- [constructor](DoStmt.md#constructor)

### Properties

- [block](DoStmt.md#block)
- [children](DoStmt.md#children)
- [condition](DoStmt.md#condition)
- [kind](DoStmt.md#kind)
- [next](DoStmt.md#next)
- [nodeKind](DoStmt.md#nodekind)
- [parent](DoStmt.md#parent)
- [prev](DoStmt.md#prev)

### Methods

- [as](DoStmt.md#as)
- [clone](DoStmt.md#clone)
- [collectChildren](DoStmt.md#collectchildren)
- [contains](DoStmt.md#contains)
- [exit](DoStmt.md#exit)
- [findCatchClause](DoStmt.md#findcatchclause)
- [findChildren](DoStmt.md#findchildren)
- [findParent](DoStmt.md#findparent)
- [getLexicalScope](DoStmt.md#getlexicalscope)
- [getVisibleNames](DoStmt.md#getvisiblenames)
- [is](DoStmt.md#is)
- [isTerminal](DoStmt.md#isterminal)
- [setParent](DoStmt.md#setparent)
- [step](DoStmt.md#step)
- [throw](DoStmt.md#throw)

## Constructors

### constructor

• **new DoStmt**(`block`, `condition`)
...
[src/statement.ts:345](https://github.com/sam-goodwin/functionless/blob/a095355/src/statement.ts#L345)
...
▸ **as**<`K`\>(`kind`): `Extract`<[`DoStmt`](DoStmt.md), { `kind`: `K`  }\>
...
`Extract`<[`DoStmt`](DoStmt.md), { `kind`: `K`  }\>
...
[src/statement.ts:351](https://github.com/sam-goodwin/functionless/blob/a095355/src/statement.ts#L351)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`DoStmt`](DoStmt.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`DoStmt`](DoStmt.md)) => node is N |
