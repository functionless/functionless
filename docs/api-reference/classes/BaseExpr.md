...
[src/node.ts:31](https://github.com/sam-goodwin/functionless/blob/72d5f75/src/node.ts#L31)
...
[src/node.ts:33](https://github.com/sam-goodwin/functionless/blob/72d5f75/src/node.ts#L33)
