...
[src/node.ts:31](https://github.com/sam-goodwin/functionless/blob/96a5ccc/src/node.ts#L31)
...
[src/node.ts:33](https://github.com/sam-goodwin/functionless/blob/96a5ccc/src/node.ts#L33)
