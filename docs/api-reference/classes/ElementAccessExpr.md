[functionless](../README.md) / [Exports](../modules.md) / ElementAccessExpr

# Class: ElementAccessExpr

## Hierarchy

- [`BaseExpr`](BaseExpr.md)<``"ElementAccessExpr"``\>
...
- [constructor](ElementAccessExpr.md#constructor)

### Properties

- [children](ElementAccessExpr.md#children)
- [element](ElementAccessExpr.md#element)
- [expr](ElementAccessExpr.md#expr)
- [kind](ElementAccessExpr.md#kind)
- [nodeKind](ElementAccessExpr.md#nodekind)
- [parent](ElementAccessExpr.md#parent)

### Methods

- [as](ElementAccessExpr.md#as)
- [clone](ElementAccessExpr.md#clone)
- [collectChildren](ElementAccessExpr.md#collectchildren)
- [contains](ElementAccessExpr.md#contains)
- [exit](ElementAccessExpr.md#exit)
- [findCatchClause](ElementAccessExpr.md#findcatchclause)
- [findChildren](ElementAccessExpr.md#findchildren)
- [findParent](ElementAccessExpr.md#findparent)
- [getLexicalScope](ElementAccessExpr.md#getlexicalscope)
- [getVisibleNames](ElementAccessExpr.md#getvisiblenames)
- [is](ElementAccessExpr.md#is)
- [isTerminal](ElementAccessExpr.md#isterminal)
- [setParent](ElementAccessExpr.md#setparent)
- [step](ElementAccessExpr.md#step)
- [throw](ElementAccessExpr.md#throw)

## Constructors

### constructor

• **new ElementAccessExpr**(`expr`, `element`)
...
[src/expression.ts:177](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L177)
...
• `Readonly` **element**: [`Expr`](../modules.md#expr)
...
• `Readonly` **kind**: ``"ElementAccessExpr"``
...
▸ **as**<`K`\>(`kind`): `Extract`<[`ElementAccessExpr`](ElementAccessExpr.md), { `kind`: `K`  }\>
...
`Extract`<[`ElementAccessExpr`](ElementAccessExpr.md), { `kind`: `K`  }\>
...
▸ **clone**(): [`ElementAccessExpr`](ElementAccessExpr.md)
...
[src/expression.ts:183](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L183)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`ElementAccessExpr`](ElementAccessExpr.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`ElementAccessExpr`](ElementAccessExpr.md)) => node is N |
