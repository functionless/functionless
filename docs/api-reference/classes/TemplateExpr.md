[functionless](../README.md) / [Exports](../modules.md) / TemplateExpr
...
- [`BaseExpr`](BaseExpr.md)<``"TemplateExpr"``\>
...
- [constructor](TemplateExpr.md#constructor)

### Properties

- [children](TemplateExpr.md#children)
- [exprs](TemplateExpr.md#exprs)
- [kind](TemplateExpr.md#kind)
- [nodeKind](TemplateExpr.md#nodekind)
- [parent](TemplateExpr.md#parent)

### Methods

- [as](TemplateExpr.md#as)
- [clone](TemplateExpr.md#clone)
- [collectChildren](TemplateExpr.md#collectchildren)
- [contains](TemplateExpr.md#contains)
- [exit](TemplateExpr.md#exit)
- [findCatchClause](TemplateExpr.md#findcatchclause)
- [findChildren](TemplateExpr.md#findchildren)
- [findParent](TemplateExpr.md#findparent)
- [getLexicalScope](TemplateExpr.md#getlexicalscope)
- [getVisibleNames](TemplateExpr.md#getvisiblenames)
- [is](TemplateExpr.md#is)
- [isTerminal](TemplateExpr.md#isterminal)
- [setParent](TemplateExpr.md#setparent)
- [step](TemplateExpr.md#step)
- [throw](TemplateExpr.md#throw)

## Constructors

### constructor

• **new TemplateExpr**(`exprs`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `exprs` | [`Expr`](../modules.md#expr)[] |
...
[src/expression.ts:505](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L505)
...
• `Readonly` **exprs**: [`Expr`](../modules.md#expr)[]

___

### kind

• `Readonly` **kind**: ``"TemplateExpr"``
...
▸ **as**<`K`\>(`kind`): `Extract`<[`TemplateExpr`](TemplateExpr.md), { `kind`: `K`  }\>
...
`Extract`<[`TemplateExpr`](TemplateExpr.md), { `kind`: `K`  }\>
...
▸ **clone**(): [`TemplateExpr`](TemplateExpr.md)
...
[src/expression.ts:510](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L510)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`TemplateExpr`](TemplateExpr.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`TemplateExpr`](TemplateExpr.md)) => node is N |
