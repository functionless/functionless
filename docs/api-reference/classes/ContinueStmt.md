[functionless](../README.md) / [Exports](../modules.md) / ContinueStmt

# Class: ContinueStmt

## Hierarchy

- [`BaseStmt`](BaseStmt.md)<``"ContinueStmt"``\>
...
- [constructor](ContinueStmt.md#constructor)

### Properties

- [children](ContinueStmt.md#children)
- [kind](ContinueStmt.md#kind)
- [next](ContinueStmt.md#next)
- [nodeKind](ContinueStmt.md#nodekind)
- [parent](ContinueStmt.md#parent)
- [prev](ContinueStmt.md#prev)

### Methods

- [as](ContinueStmt.md#as)
- [clone](ContinueStmt.md#clone)
- [collectChildren](ContinueStmt.md#collectchildren)
- [contains](ContinueStmt.md#contains)
- [exit](ContinueStmt.md#exit)
- [findCatchClause](ContinueStmt.md#findcatchclause)
- [findChildren](ContinueStmt.md#findchildren)
- [findParent](ContinueStmt.md#findparent)
- [getLexicalScope](ContinueStmt.md#getlexicalscope)
- [getVisibleNames](ContinueStmt.md#getvisiblenames)
- [is](ContinueStmt.md#is)
- [isTerminal](ContinueStmt.md#isterminal)
- [setParent](ContinueStmt.md#setparent)
- [step](ContinueStmt.md#step)
- [throw](ContinueStmt.md#throw)
...
[src/statement.ts:251](https://github.com/sam-goodwin/functionless/blob/a095355/src/statement.ts#L251)
...
▸ **as**<`K`\>(`kind`): `Extract`<[`ContinueStmt`](ContinueStmt.md), { `kind`: `K`  }\>
...
`Extract`<[`ContinueStmt`](ContinueStmt.md), { `kind`: `K`  }\>
...
▸ **clone**(): [`ContinueStmt`](ContinueStmt.md)
...
[src/statement.ts:255](https://github.com/sam-goodwin/functionless/blob/a095355/src/statement.ts#L255)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`ContinueStmt`](ContinueStmt.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`ContinueStmt`](ContinueStmt.md)) => node is N |
