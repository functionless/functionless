[functionless](../README.md) / [Exports](../modules.md) / ForInStmt

# Class: ForInStmt

## Hierarchy

- [`BaseStmt`](BaseStmt.md)<``"ForInStmt"``\>
...
- [constructor](ForInStmt.md#constructor)

### Properties

- [body](ForInStmt.md#body)
- [children](ForInStmt.md#children)
- [expr](ForInStmt.md#expr)
- [kind](ForInStmt.md#kind)
- [next](ForInStmt.md#next)
- [nodeKind](ForInStmt.md#nodekind)
- [parent](ForInStmt.md#parent)
- [prev](ForInStmt.md#prev)
- [variableDecl](ForInStmt.md#variabledecl)

### Methods

- [as](ForInStmt.md#as)
- [clone](ForInStmt.md#clone)
- [collectChildren](ForInStmt.md#collectchildren)
- [contains](ForInStmt.md#contains)
- [exit](ForInStmt.md#exit)
- [findCatchClause](ForInStmt.md#findcatchclause)
- [findChildren](ForInStmt.md#findchildren)
- [findParent](ForInStmt.md#findparent)
- [getLexicalScope](ForInStmt.md#getlexicalscope)
- [getVisibleNames](ForInStmt.md#getvisiblenames)
- [is](ForInStmt.md#is)
- [isTerminal](ForInStmt.md#isterminal)
- [setParent](ForInStmt.md#setparent)
- [step](ForInStmt.md#step)
- [throw](ForInStmt.md#throw)
...
[src/statement.ts:216](https://github.com/sam-goodwin/functionless/blob/a095355/src/statement.ts#L216)
...
▸ **as**<`K`\>(`kind`): `Extract`<[`ForInStmt`](ForInStmt.md), { `kind`: `K`  }\>
...
`Extract`<[`ForInStmt`](ForInStmt.md), { `kind`: `K`  }\>
...
[src/statement.ts:227](https://github.com/sam-goodwin/functionless/blob/a095355/src/statement.ts#L227)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`ForInStmt`](ForInStmt.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`ForInStmt`](ForInStmt.md)) => node is N |
