[functionless](../README.md) / [Exports](../modules.md) / BooleanLiteralExpr

# Class: BooleanLiteralExpr

## Hierarchy

- [`BaseExpr`](BaseExpr.md)<``"BooleanLiteralExpr"``\>
...
- [constructor](BooleanLiteralExpr.md#constructor)

### Properties

- [children](BooleanLiteralExpr.md#children)
- [kind](BooleanLiteralExpr.md#kind)
- [nodeKind](BooleanLiteralExpr.md#nodekind)
- [parent](BooleanLiteralExpr.md#parent)
- [value](BooleanLiteralExpr.md#value)

### Methods

- [as](BooleanLiteralExpr.md#as)
- [clone](BooleanLiteralExpr.md#clone)
- [collectChildren](BooleanLiteralExpr.md#collectchildren)
- [contains](BooleanLiteralExpr.md#contains)
- [exit](BooleanLiteralExpr.md#exit)
- [findCatchClause](BooleanLiteralExpr.md#findcatchclause)
- [findChildren](BooleanLiteralExpr.md#findchildren)
- [findParent](BooleanLiteralExpr.md#findparent)
- [getLexicalScope](BooleanLiteralExpr.md#getlexicalscope)
- [getVisibleNames](BooleanLiteralExpr.md#getvisiblenames)
- [is](BooleanLiteralExpr.md#is)
- [isTerminal](BooleanLiteralExpr.md#isterminal)
- [setParent](BooleanLiteralExpr.md#setparent)
- [step](BooleanLiteralExpr.md#step)
- [throw](BooleanLiteralExpr.md#throw)
...
[src/expression.ts:349](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L349)
...
▸ **as**<`K`\>(`kind`): `Extract`<[`BooleanLiteralExpr`](BooleanLiteralExpr.md), { `kind`: `K`  }\>
...
`Extract`<[`BooleanLiteralExpr`](BooleanLiteralExpr.md), { `kind`: `K`  }\>
...
▸ **clone**(): [`BooleanLiteralExpr`](BooleanLiteralExpr.md)
...
[src/expression.ts:353](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L353)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`BooleanLiteralExpr`](BooleanLiteralExpr.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`BooleanLiteralExpr`](BooleanLiteralExpr.md)) => node is N |
