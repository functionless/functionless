[functionless](../README.md) / [Exports](../modules.md) / ExprStmt

# Class: ExprStmt

## Hierarchy

- [`BaseStmt`](BaseStmt.md)<``"ExprStmt"``\>
...
- [constructor](ExprStmt.md#constructor)

### Properties

- [children](ExprStmt.md#children)
- [expr](ExprStmt.md#expr)
- [kind](ExprStmt.md#kind)
- [next](ExprStmt.md#next)
- [nodeKind](ExprStmt.md#nodekind)
- [parent](ExprStmt.md#parent)
- [prev](ExprStmt.md#prev)

### Methods

- [as](ExprStmt.md#as)
- [clone](ExprStmt.md#clone)
- [collectChildren](ExprStmt.md#collectchildren)
- [contains](ExprStmt.md#contains)
- [exit](ExprStmt.md#exit)
- [findCatchClause](ExprStmt.md#findcatchclause)
- [findChildren](ExprStmt.md#findchildren)
- [findParent](ExprStmt.md#findparent)
- [getLexicalScope](ExprStmt.md#getlexicalscope)
- [getVisibleNames](ExprStmt.md#getvisiblenames)
- [is](ExprStmt.md#is)
- [isTerminal](ExprStmt.md#isterminal)
- [setParent](ExprStmt.md#setparent)
- [step](ExprStmt.md#step)
- [throw](ExprStmt.md#throw)
...
[src/statement.ts:62](https://github.com/sam-goodwin/functionless/blob/a095355/src/statement.ts#L62)
...
▸ **as**<`K`\>(`kind`): `Extract`<[`ExprStmt`](ExprStmt.md), { `kind`: `K`  }\>
...
`Extract`<[`ExprStmt`](ExprStmt.md), { `kind`: `K`  }\>
...
[src/statement.ts:67](https://github.com/sam-goodwin/functionless/blob/a095355/src/statement.ts#L67)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`ExprStmt`](ExprStmt.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`ExprStmt`](ExprStmt.md)) => node is N |
