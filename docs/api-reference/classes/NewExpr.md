[functionless](../README.md) / [Exports](../modules.md) / NewExpr

# Class: NewExpr

## Hierarchy

- [`BaseExpr`](BaseExpr.md)<``"NewExpr"``\>
...
- [constructor](NewExpr.md#constructor)

### Properties

- [args](NewExpr.md#args)
- [children](NewExpr.md#children)
- [expr](NewExpr.md#expr)
- [kind](NewExpr.md#kind)
- [nodeKind](NewExpr.md#nodekind)
- [parent](NewExpr.md#parent)

### Methods

- [as](NewExpr.md#as)
- [clone](NewExpr.md#clone)
- [collectChildren](NewExpr.md#collectchildren)
- [contains](NewExpr.md#contains)
- [exit](NewExpr.md#exit)
- [findCatchClause](NewExpr.md#findcatchclause)
- [findChildren](NewExpr.md#findchildren)
- [findParent](NewExpr.md#findparent)
- [getLexicalScope](NewExpr.md#getlexicalscope)
- [getVisibleNames](NewExpr.md#getvisiblenames)
- [is](NewExpr.md#is)
- [isTerminal](NewExpr.md#isterminal)
- [setParent](NewExpr.md#setparent)
- [step](NewExpr.md#step)
- [throw](NewExpr.md#throw)

## Constructors

### constructor

• **new NewExpr**(`expr`, `args`)
...
[src/expression.ts:228](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L228)
...
▸ **as**<`K`\>(`kind`): `Extract`<[`NewExpr`](NewExpr.md), { `kind`: `K`  }\>
...
`Extract`<[`NewExpr`](NewExpr.md), { `kind`: `K`  }\>
...
[src/expression.ts:238](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L238)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`NewExpr`](NewExpr.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`NewExpr`](NewExpr.md)) => node is N |
