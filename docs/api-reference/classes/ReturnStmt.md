[functionless](../README.md) / [Exports](../modules.md) / ReturnStmt

# Class: ReturnStmt

## Hierarchy

- [`BaseStmt`](BaseStmt.md)<``"ReturnStmt"``\>
...
- [constructor](ReturnStmt.md#constructor)

### Properties

- [children](ReturnStmt.md#children)
- [expr](ReturnStmt.md#expr)
- [kind](ReturnStmt.md#kind)
- [next](ReturnStmt.md#next)
- [nodeKind](ReturnStmt.md#nodekind)
- [parent](ReturnStmt.md#parent)
- [prev](ReturnStmt.md#prev)

### Methods

- [as](ReturnStmt.md#as)
- [clone](ReturnStmt.md#clone)
- [collectChildren](ReturnStmt.md#collectchildren)
- [contains](ReturnStmt.md#contains)
- [exit](ReturnStmt.md#exit)
- [findCatchClause](ReturnStmt.md#findcatchclause)
- [findChildren](ReturnStmt.md#findchildren)
- [findParent](ReturnStmt.md#findparent)
- [getLexicalScope](ReturnStmt.md#getlexicalscope)
- [getVisibleNames](ReturnStmt.md#getvisiblenames)
- [is](ReturnStmt.md#is)
- [isTerminal](ReturnStmt.md#isterminal)
- [setParent](ReturnStmt.md#setparent)
- [step](ReturnStmt.md#step)
- [throw](ReturnStmt.md#throw)
...
[src/statement.ts:155](https://github.com/sam-goodwin/functionless/blob/a095355/src/statement.ts#L155)
...
▸ **as**<`K`\>(`kind`): `Extract`<[`ReturnStmt`](ReturnStmt.md), { `kind`: `K`  }\>
...
`Extract`<[`ReturnStmt`](ReturnStmt.md), { `kind`: `K`  }\>
...
▸ **clone**(): [`ReturnStmt`](ReturnStmt.md)
...
[src/statement.ts:160](https://github.com/sam-goodwin/functionless/blob/a095355/src/statement.ts#L160)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`ReturnStmt`](ReturnStmt.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`ReturnStmt`](ReturnStmt.md)) => node is N |
