[functionless](../README.md) / [Exports](../modules.md) / Identifier

# Class: Identifier

## Hierarchy

- [`BaseExpr`](BaseExpr.md)<``"Identifier"``\>
...
- [children](Identifier.md#children)
- [kind](Identifier.md#kind)
- [name](Identifier.md#name)
- [nodeKind](Identifier.md#nodekind)
- [parent](Identifier.md#parent)

### Methods

- [as](Identifier.md#as)
- [clone](Identifier.md#clone)
- [collectChildren](Identifier.md#collectchildren)
- [contains](Identifier.md#contains)
- [exit](Identifier.md#exit)
- [findCatchClause](Identifier.md#findcatchclause)
- [findChildren](Identifier.md#findchildren)
- [findParent](Identifier.md#findparent)
- [getLexicalScope](Identifier.md#getlexicalscope)
- [getVisibleNames](Identifier.md#getvisiblenames)
- [is](Identifier.md#is)
- [isTerminal](Identifier.md#isterminal)
- [lookup](Identifier.md#lookup)
- [setParent](Identifier.md#setparent)
- [step](Identifier.md#step)
- [throw](Identifier.md#throw)
...
[src/expression.ts:148](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L148)
...
▸ **as**<`K`\>(`kind`): `Extract`<[`Identifier`](Identifier.md), { `kind`: `K`  }\>
...
`Extract`<[`Identifier`](Identifier.md), { `kind`: `K`  }\>
...
[src/expression.ts:152](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L152)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`Identifier`](Identifier.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`Identifier`](Identifier.md)) => node is N |
...
▸ **lookup**(): `undefined` \| [`ParameterDecl`](ParameterDecl.md) \| [`VariableStmt`](VariableStmt.md)<`undefined` \| [`Expr`](../modules.md#expr)\>

#### Returns

`undefined` \| [`ParameterDecl`](ParameterDecl.md) \| [`VariableStmt`](VariableStmt.md)<`undefined` \| [`Expr`](../modules.md#expr)\>

#### Defined in

[src/expression.ts:156](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L156)
