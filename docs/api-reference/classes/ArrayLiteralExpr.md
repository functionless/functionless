[functionless](../README.md) / [Exports](../modules.md) / ArrayLiteralExpr

# Class: ArrayLiteralExpr

## Hierarchy

- [`BaseExpr`](BaseExpr.md)<``"ArrayLiteralExpr"``\>
...
- [constructor](ArrayLiteralExpr.md#constructor)

### Properties

- [children](ArrayLiteralExpr.md#children)
- [items](ArrayLiteralExpr.md#items)
- [kind](ArrayLiteralExpr.md#kind)
- [nodeKind](ArrayLiteralExpr.md#nodekind)
- [parent](ArrayLiteralExpr.md#parent)

### Methods

- [as](ArrayLiteralExpr.md#as)
- [clone](ArrayLiteralExpr.md#clone)
- [collectChildren](ArrayLiteralExpr.md#collectchildren)
- [contains](ArrayLiteralExpr.md#contains)
- [exit](ArrayLiteralExpr.md#exit)
- [findCatchClause](ArrayLiteralExpr.md#findcatchclause)
- [findChildren](ArrayLiteralExpr.md#findchildren)
- [findParent](ArrayLiteralExpr.md#findparent)
- [getLexicalScope](ArrayLiteralExpr.md#getlexicalscope)
- [getVisibleNames](ArrayLiteralExpr.md#getvisiblenames)
- [is](ArrayLiteralExpr.md#is)
- [isTerminal](ArrayLiteralExpr.md#isterminal)
- [setParent](ArrayLiteralExpr.md#setparent)
- [step](ArrayLiteralExpr.md#step)
- [throw](ArrayLiteralExpr.md#throw)

## Constructors

### constructor

• **new ArrayLiteralExpr**(`items`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `items` | [`Expr`](../modules.md#expr)[] |
...
[src/expression.ts:385](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L385)
...
• `Readonly` **items**: [`Expr`](../modules.md#expr)[]

___

### kind

• `Readonly` **kind**: ``"ArrayLiteralExpr"``
...
▸ **as**<`K`\>(`kind`): `Extract`<[`ArrayLiteralExpr`](ArrayLiteralExpr.md), { `kind`: `K`  }\>
...
`Extract`<[`ArrayLiteralExpr`](ArrayLiteralExpr.md), { `kind`: `K`  }\>
...
▸ **clone**(): [`ArrayLiteralExpr`](ArrayLiteralExpr.md)
...
[src/expression.ts:390](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L390)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`ArrayLiteralExpr`](ArrayLiteralExpr.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`ArrayLiteralExpr`](ArrayLiteralExpr.md)) => node is N |
