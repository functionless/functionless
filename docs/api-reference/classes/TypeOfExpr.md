[functionless](../README.md) / [Exports](../modules.md) / TypeOfExpr

# Class: TypeOfExpr

## Hierarchy

- [`BaseExpr`](BaseExpr.md)<``"TypeOfExpr"``\>
...
- [constructor](TypeOfExpr.md#constructor)

### Properties

- [children](TypeOfExpr.md#children)
- [expr](TypeOfExpr.md#expr)
- [kind](TypeOfExpr.md#kind)
- [nodeKind](TypeOfExpr.md#nodekind)
- [parent](TypeOfExpr.md#parent)

### Methods

- [as](TypeOfExpr.md#as)
- [clone](TypeOfExpr.md#clone)
- [collectChildren](TypeOfExpr.md#collectchildren)
- [contains](TypeOfExpr.md#contains)
- [exit](TypeOfExpr.md#exit)
- [findCatchClause](TypeOfExpr.md#findcatchclause)
- [findChildren](TypeOfExpr.md#findchildren)
- [findParent](TypeOfExpr.md#findparent)
- [getLexicalScope](TypeOfExpr.md#getlexicalscope)
- [getVisibleNames](TypeOfExpr.md#getvisiblenames)
- [is](TypeOfExpr.md#is)
- [isTerminal](TypeOfExpr.md#isterminal)
- [setParent](TypeOfExpr.md#setparent)
- [step](TypeOfExpr.md#step)
- [throw](TypeOfExpr.md#throw)
...
[src/expression.ts:518](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L518)
...
▸ **as**<`K`\>(`kind`): `Extract`<[`TypeOfExpr`](TypeOfExpr.md), { `kind`: `K`  }\>
...
`Extract`<[`TypeOfExpr`](TypeOfExpr.md), { `kind`: `K`  }\>
...
▸ **clone**(): [`TypeOfExpr`](TypeOfExpr.md)
...
[src/expression.ts:522](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L522)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`TypeOfExpr`](TypeOfExpr.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`TypeOfExpr`](TypeOfExpr.md)) => node is N |
