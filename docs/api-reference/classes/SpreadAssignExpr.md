[functionless](../README.md) / [Exports](../modules.md) / SpreadAssignExpr

# Class: SpreadAssignExpr

## Hierarchy

- [`BaseExpr`](BaseExpr.md)<``"SpreadAssignExpr"``, [`ObjectLiteralExpr`](ObjectLiteralExpr.md)\>
...
- [constructor](SpreadAssignExpr.md#constructor)

### Properties

- [children](SpreadAssignExpr.md#children)
- [expr](SpreadAssignExpr.md#expr)
- [kind](SpreadAssignExpr.md#kind)
- [nodeKind](SpreadAssignExpr.md#nodekind)
- [parent](SpreadAssignExpr.md#parent)

### Methods

- [as](SpreadAssignExpr.md#as)
- [clone](SpreadAssignExpr.md#clone)
- [collectChildren](SpreadAssignExpr.md#collectchildren)
- [contains](SpreadAssignExpr.md#contains)
- [exit](SpreadAssignExpr.md#exit)
- [findCatchClause](SpreadAssignExpr.md#findcatchclause)
- [findChildren](SpreadAssignExpr.md#findchildren)
- [findParent](SpreadAssignExpr.md#findparent)
- [getLexicalScope](SpreadAssignExpr.md#getlexicalscope)
- [getVisibleNames](SpreadAssignExpr.md#getvisiblenames)
- [is](SpreadAssignExpr.md#is)
- [isTerminal](SpreadAssignExpr.md#isterminal)
- [setParent](SpreadAssignExpr.md#setparent)
- [step](SpreadAssignExpr.md#step)
- [throw](SpreadAssignExpr.md#throw)

## Constructors

### constructor

• **new SpreadAssignExpr**(`expr`)
...
[src/expression.ts:473](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L473)
...
• `Readonly` **kind**: ``"SpreadAssignExpr"``
...
▸ **as**<`K`\>(`kind`): `Extract`<[`SpreadAssignExpr`](SpreadAssignExpr.md), { `kind`: `K`  }\>
...
`Extract`<[`SpreadAssignExpr`](SpreadAssignExpr.md), { `kind`: `K`  }\>
...
▸ **clone**(): [`SpreadAssignExpr`](SpreadAssignExpr.md)
...
[src/expression.ts:478](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L478)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`SpreadAssignExpr`](SpreadAssignExpr.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`SpreadAssignExpr`](SpreadAssignExpr.md)) => node is N |
