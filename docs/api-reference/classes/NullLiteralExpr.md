[functionless](../README.md) / [Exports](../modules.md) / NullLiteralExpr

# Class: NullLiteralExpr

## Hierarchy

- [`BaseExpr`](BaseExpr.md)<``"NullLiteralExpr"``\>
...
- [constructor](NullLiteralExpr.md#constructor)

### Properties

- [children](NullLiteralExpr.md#children)
- [kind](NullLiteralExpr.md#kind)
- [nodeKind](NullLiteralExpr.md#nodekind)
- [parent](NullLiteralExpr.md#parent)
- [value](NullLiteralExpr.md#value)

### Methods

- [as](NullLiteralExpr.md#as)
- [clone](NullLiteralExpr.md#clone)
- [collectChildren](NullLiteralExpr.md#collectchildren)
- [contains](NullLiteralExpr.md#contains)
- [exit](NullLiteralExpr.md#exit)
- [findCatchClause](NullLiteralExpr.md#findcatchclause)
- [findChildren](NullLiteralExpr.md#findchildren)
- [findParent](NullLiteralExpr.md#findparent)
- [getLexicalScope](NullLiteralExpr.md#getlexicalscope)
- [getVisibleNames](NullLiteralExpr.md#getvisiblenames)
- [is](NullLiteralExpr.md#is)
- [isTerminal](NullLiteralExpr.md#isterminal)
- [setParent](NullLiteralExpr.md#setparent)
- [step](NullLiteralExpr.md#step)
- [throw](NullLiteralExpr.md#throw)
...
[src/expression.ts:323](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L323)
...
[src/expression.ts:322](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L322)

## Methods

### as

▸ **as**<`K`\>(`kind`): `Extract`<[`NullLiteralExpr`](NullLiteralExpr.md), { `kind`: `K`  }\>
...
`Extract`<[`NullLiteralExpr`](NullLiteralExpr.md), { `kind`: `K`  }\>
...
▸ **clone**(): [`NullLiteralExpr`](NullLiteralExpr.md)
...
[src/expression.ts:327](https://github.com/sam-goodwin/functionless/blob/a095355/src/expression.ts#L327)
...
| Name | Type |
| :------ | :------ |
| `N` | extends [`NullLiteralExpr`](NullLiteralExpr.md)<`N`\> |

#### Parameters

| Name | Type |
| :------ | :------ |
| `is` | (`node`: [`NullLiteralExpr`](NullLiteralExpr.md)) => node is N |
