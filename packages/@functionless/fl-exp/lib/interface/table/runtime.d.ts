...
import { BatchGetItem } from "./batch-get-item";
...
import { TransactGetItems } from "./transact-get-item";
import { TransactWriteItems } from "./transact-write-item";
 ...
 */
interface TableRuntimeApi<Item extends object, PartitionKey extends keyof Item, RangeKey extends keyof Item | undefined, Format extends JsonFormat> {
...
export interface TableDocumentApi<Item extends object, PartitionKey extends keyof Item, RangeKey extends keyof Item | undefined> extends TableRuntimeApi<Item, PartitionKey, RangeKey, JsonFormat.Document> {
}
/**
...
export interface TableDocumentApi<Item extends object, PartitionKey extends keyof Item, RangeKey extends keyof Item | undefined> extends TableRuntimeApi<Item, PartitionKey, RangeKey, JsonFormat.Document> {
     ...
     */
    readonly update: UpdateItem<Item, PartitionKey, RangeKey, JsonFormat.Document>;
    /**
     ...
     */
    readonly delete: DeleteItem<Item, PartitionKey, RangeKey, JsonFormat.Document>;
    /**
     ...
     */
    readonly batchGet: BatchGetItem<Item, PartitionKey, RangeKey, JsonFormat.Document>;
    /**
     ...
     */
    readonly batchWrite: BatchWriteItem<Item, PartitionKey, RangeKey, JsonFormat.Document>;
    /**
     ...
     */
    readonly transactGet: TransactGetItems<Item, PartitionKey, RangeKey, JsonFormat.Document>;
    /**
     ...
     */
    readonly transactWrite: TransactWriteItems<Item, PartitionKey, RangeKey, JsonFormat.Document>;
}
export interface TableAttributesApi<Item extends object, PartitionKey extends keyof Item, RangeKey extends keyof Item | undefined> extends TableRuntimeApi<Item, PartitionKey, RangeKey, JsonFormat.AttributeValue> {
}
/**
 ...
 * @tparam {@link RangeKey} - the name of the Range Key field if specified, otherwise undefined
 */
export interface TableAttributesApi<Item extends object, PartitionKey extends keyof Item, RangeKey extends keyof Item | undefined> {
    /**
     * The `get` operation returns a set of attributes for the item with the given
     * primary key. If there is no matching item, `get` does not return any data
     * and there will be no `Item` element in the response.
     ...
     */
    readonly get: GetItem<Item, PartitionKey, RangeKey, JsonFormat.AttributeValue>;
    /**
     * Creates a new item, or replaces an old item with a new item. If an item that
     * has the same primary key as the new item already exists in the specified table,
     * the new item completely replaces the existing item.
     ...
     * @see [UpdateItem API Reference](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_UpdateItem.html)
     */
    readonly update: UpdateItem<Item, PartitionKey, RangeKey, JsonFormat.AttributeValue>;
    /**
     * Deletes a single item in a table by primary key.
     *
     * ```ts
     ...
     * @see [DeleteItem API Reference](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_DeleteItem.html)
     */
    readonly delete: DeleteItem<Item, PartitionKey, RangeKey, JsonFormat.AttributeValue>;
    /**
     * `query` returns all items that contain a partition key value. Use the `KeyConditionExpression`
     * parameter to provide a specific value for the partition key. The `query` operation will return
     * all of the items from the table or index with that partition key value.
     ...
     * `FilterExpression`.
     */
    readonly query: Query<Item, PartitionKey, RangeKey, JsonFormat.AttributeValue>;
    /**
     * The `scan` operation returns one or more items and item attributes by accessing every item in
     * table or a secondary index.
     * ```ts
     ...
     */
    readonly batchGet: BatchGetItem<Item, PartitionKey, RangeKey, JsonFormat.AttributeValue>;
    /**
     * The `batchWrite` operation puts or deletes multiple items in one or more tables.
     *
     * ```ts
     ...
     * @see [BatchWriteItem API](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_BatchWriteItem.html)
     */
    readonly batchWrite: BatchWriteItem<Item, PartitionKey, RangeKey, JsonFormat.AttributeValue>;
    /**
     * `transactGet` is a synchronous operation that atomically retrieves multiple items
     * from a table. A `transactGet` call can contain up to `25` {@link TransactGetItem} objects,
     * each of which contains a {@link Get} structure that specifies an item to retrieve from the
     ...
     * @see [TransactGetItems API Reference](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_TransactGetItems.html)
     */
    readonly transactGet: TransactGetItems<Item, PartitionKey, RangeKey, JsonFormat.AttributeValue>;
    /**
     * TransactWriteItems is a synchronous write operation that groups up to **25** action
     * requests. No two actions can target the same item. For example, you cannot both
     * {@link ConditionCheck} and {@link Update} the same item.
     ...
     * @see [TransactWriteItems API Reference](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_TransactWriteItems.html)
     */
    readonly transactWrite: TransactWriteItems<Item, PartitionKey, RangeKey, JsonFormat.AttributeValue>;
}
export {};
