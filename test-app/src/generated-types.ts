...
> = {
  ...
  addPerson2: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationAddPerson2Args, "input">
  >;
  ...
  updateName: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateNameArgs, "id" | "name">
  >;
};
...
export type ProcessedPersonResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ProcessedPerson"] = ResolversParentTypes["ProcessedPerson"]
> = {
  id: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  name: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
> = {
  getPerson: Resolver<
    Maybe<ResolversTypes["ProcessedPerson"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetPersonArgs, "id">
  >;
};
