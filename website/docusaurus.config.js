...
const config = {
  title: "Simple and concise cloud programming",
  tagline:
    "Functionless infers boilerplate configurations and domain specific languages for your favorite Infrastructure-as-Code TypeScript frameworks.",
