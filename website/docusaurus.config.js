...
const config = {
  title: "Zero mess Serverless, just write code",
  tagline:
    "Functionless is an open source Infrastructure as Code library that generates complex cloud configurations from simple, type-safe code",
