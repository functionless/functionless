...
const config = {
  ...
  tagline:
    "Functionless removes boilerplate configurations and domain specific languages from your favorite Infrastructure-as-Code (IaC) frameworks by inferring them from TypeScript.",
